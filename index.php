<html>
	...
	<div id='clima' style="width:30%;">
        ...
        <div class="ideaboxNews in-easing noticias" id="idx1">
            <h3 style="background-color: #007FAA">Noticias</h3>
            <ul>      	 
...
src="https://youtube.com/embed/97fBxHm6Nas?autoplay=1&controls=0&showinfo=0&autohide=1">
    ...
    <!--<embed src="https://www.youtube.com/watch?v=xs0vV0IvYmg" autostart=false true loop=true width="0" height="0">-->
    <!--<iframe width="0" height="0" src="https://www.youtube.com/watch?v=97fBxHm6Nas" ></iframe>-->
</html>